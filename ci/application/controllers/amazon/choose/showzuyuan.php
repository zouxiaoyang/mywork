<?php
	class showzuyuan extends CI_Controller{
...
//		添加分页		
			...
			$total_num = count($res);
			$config['base_url'] = '/amazon/choose/showzuyuan/showmessage/';
...
//	调用moddel;
			// 获取该组的所有数据;
			$this->load->model('amazon/zhanghu/getzuyuan','cc');

			$result = $this->cc->getzuyuan_message($arr_zhanghu,$value,$cur_page,$config['per_page'],$choose);
